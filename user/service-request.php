...
if(isset($_POST['submit']))
  {
    $uid=$_SESSION['sid'];
     ...
     $query=mysqli_query($con,"insert into tblservicerequest(UserId,Category,ServiceNumber,VehicleName,serviceType,VehicleBrand,VehicleRegno,ServiceDate,ServiceTime,DeliveryType,PickupAddress) value('$uid','$category','$sernumber','$vehname','$serviceType','$vehbrand','$vehrego','$vehservicedate','$vehservicetime','$deltype','$pickupadd')");
    if ($query) {
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Jaffna Garage and Service Station</title>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title">Jaffna Garage and Service Station</h4>
              ...
              <option value="<?php echo $row['VehicleCat'];?>"><?php echo $row['VehicleCat'];?></option>
                  <?php } ?>  
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <select name='serviceType' id="serviceType" class="form-control" required="true">
