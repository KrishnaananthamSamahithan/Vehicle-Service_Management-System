...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2023 at 02:23 PM
...
CREATE TABLE `tblservicerequest` (
  ...
  `serviceType` varchar(120) DEFAULT NULL,
...
INSERT INTO `tblservicerequest` (`ID`, `UserId`, `ServiceNumber`, `Category`, `VehicleName`, `serviceType`, `VehicleBrand`, `VehicleRegno`, `ServiceDate`, `ServiceTime`, `DeliveryType`, `PickupAddress`, `ServicerequestDate`, `ServiceBy`, `ServiceCharge`, `PartsCharge`, `OtherCharge`, `AdminRemark`, `AdminStatus`, `AdminRemarkdate`) VALUES
...
INSERT INTO `tblservicetype` (`id`, `type`) VALUES
(1, 'Wash and Grooming'),
(2, 'Lube Service'),
(3, 'Exterior & Interior Detailing'),
(4, 'Engine Tune Ups'),
(5, 'Wash and Grooming'),
(6, 'Undercarriage Degreasing'),
(7, 'Inspection Reports'),
(8, 'Insurance Claims'),
(9, 'Wheel Alignment'),
(10, 'Battery Service'),
(11, 'Mechanical Service'),
(12, 'Full Paints'),
(13, 'Hybrid Service'),
(14, 'Part Replacement'),
(15, 'Windscreen Treatement');
...
(16, 'Samahithan Krishnaanantham', 766423744, 'k.samahithan@gmail.com', 'b372a3fd4810e7c658d62e383a4f6699', '2023-04-29 16:17:20');
